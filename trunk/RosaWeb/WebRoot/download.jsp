	   ...
	   <TD>			
	     <TABLE width="100%" bgcolor=#dfdfef  border="0" cellspacing="1" cellpadding="0"> 
	     	<TR bgcolor="#FFFFFF">
              ...
              <TD width=80><a href="download/documents/AskRosaOverview.pdf" target=_blank><bean:message key="ftpsearch.jsp.searchtrue.download"/></a></TD>
              <TD width=70 >2009-09-12</TD>
            </TR>            
	      	<TR bgcolor="#F5F8FE">
              <TD  width=30 height=18></TD>
              <TD style="text-align:left">&nbsp;&nbsp;Rosa使用手册（1.9M）</TD>
              <TD width=80><a href="download/documents/AskRosaManual.pdf" target=_blank><bean:message key="ftpsearch.jsp.searchtrue.download"/></a></TD>
              <TD width=70 >2009-09-12</TD>
            </TR>            
	      	<TR bgcolor="#FFFFFF">
              <TD  width=30 height=18></TD>
              <TD style="text-align:left">&nbsp;&nbsp;Rosa设计说明（400K）</TD>
              <TD width=80><a href="download/documents/AskRosaDesign.pdf" target=_blank><bean:message key="ftpsearch.jsp.searchtrue.download"/></a></TD>
              <TD width=70 >2009-09-12</TD>
            </TR>
 	        <TR bgcolor="#F5F8FE">
              <TD  width=30 height=18></TD>
            ...
            <TR bgcolor="#FFFFFF">
              ...
              <TD ><a href="download/RosaAll.zip" target=_blank><bean:message key="ftpsearch.jsp.searchtrue.download"/></a></TD>
              <TD >2009-09-12</TD>
            </TR> 
  	        <TR bgcolor="#F5F8FE">
              <TD  height=18></TD>
              <TD style="text-align:left">&nbsp;&nbsp;如果您只需要源码（10M）</TD>
              <TD><a href="download/rosa.zip" target=_blank><bean:message key="ftpsearch.jsp.searchtrue.download"/></a></TD>
              <TD >2009-09-12</TD>
            </TR>              
 	        <TR bgcolor="#FFFFFF">
              <TD height=18></TD>
