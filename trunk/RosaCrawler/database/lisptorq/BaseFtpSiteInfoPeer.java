...
public class BaseFtpSiteInfoPeer  { 
	...
	throws Exception{ 
				...
				ret.torrent=results.getInt("TORRENT");
    ...
    private static class FtpSiteInfoScroller implements Scroller{
