...
/**
 * Autogenerated by Lisptorq 0.1.4 from default-criteria.template
 */
...
public class Criteria
{
    ...
    private ArrayList<String> _orderBy = null;
    ...
    public Criteria compareWithColumn(String field1, String field2,
	    String comparison)
    {
    ...
    {
	if (null == _orderBy)
	    _orderBy = new ArrayList<String>();
	if (!_orderBy.contains(order))
	    _orderBy.add(order);
	return this;
    }
	...
	private ArrayList<Criterion> conjunctions = null;

	private ArrayList<String> conjunctionTypes = null;

	// ------------ used internally only -----------

	private Criterion(String f, Object v, String c, boolean b,
		boolean escaped)
	{
	    field = f;
	    value = v;
	...
	private Criterion addConjunction(Criterion c, String type)
	{
		...
		conjunctions = new ArrayList<Criterion>();
	    if (null == conjunctionTypes)
		conjunctionTypes = new ArrayList<String>();
	...
	if (null == _head)
	    return sb;
	ArrayList<String> tables = collectTables(_head, new ArrayList<String>());
	Object[] objs = tables.toArray();
	for (int i = objs.length - 1; i >= 0; i--)
	{
	    String s = objs[i].toString();
	    if (!s.equals(leadTable))
		sb.append(",").append(s);
	}
	return sb;
    }

    private ArrayList<String> collectTables(Criterion c, ArrayList<String> h)
    {
	if (null == c)
	    return h;
	String t = c.getTable();
	...
	if (null == _orderBy || _orderBy.size() < 1)
	    return;
