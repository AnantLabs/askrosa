...
//	c.set(Calendar.SECOND, 0);
	...
	try
	{
	    Directory dir = FSDirectory.getDirectory(CrawlerSetting
		    .getProperty("index"));
		...
		registry
			.rebind(CrawlerSetting.getProperty("node.name"), remote);
	...
	try
	{
		...
		try
		{
		    ...
		    SearchResult result = FtpSearch.search(parameter,true,false);
