...
public class StandardTokenizer extends Tokenizer
{
    ...
    { "<ALPHANUM>", "<APOSTROPHE>", "<ACRONYM>", "<COMPANY>", "<EMAIL>",
	    "<HOST>", "<NUM>", "<CJ>", "<ACRONYM_DEP>" };
     ...
     * This is false by default to support backward compatibility. <p/> See
     ...
     *                Set to true to replace mischaracterized acronyms with
     *                HOST. See http://issues.apache.org/jira/browse/LUCENE-1068
     */
	...
	while (true)
	{
		...
		else
		{
		    ...
		    {
			Tokenizer lt = new LetterDigitBreakTokenizer(
				new StringReader(reusableToken.term()));
			Token tk = null;
